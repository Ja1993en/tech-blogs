...
const dataPost = [
    {
        ...
        post_content: "Taskmaster is a task-tracker app that will allow you to organize your personal to-do list items by clicking and dragging them into categories like To Do, In Progress, and Completed.",
        user_id: 3
    },
    {
    ...
    {
        title: "Tech Blog is now released!",
...
const seedPosts = () => Post.bulkCreate(dataPost);
